...
const int16_t __attribute__((used)) _cas_constants[] PROGMEM = {
#if (FHT_N ==  256)
...
#if (REORDER == 1)
  const uint8_t __attribute__((used)) _reorder_table[] PROGMEM = {
  #if (FHT_N == 256)
...
#if (LIN_OUT == 1)
  const uint8_t __attribute__((used)) _lin_table[] PROGMEM = {
  ...
  const int16_t __attribute__((used)) _window_func[] PROGMEM = {
  #if (FHT_N ==  256)
